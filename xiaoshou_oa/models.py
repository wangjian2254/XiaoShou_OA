...
class UserQianDao(models.Model):
    ...
    dateTime = models.DateTimeField(default=getDateTime,auto_created=True, verbose_name=u'签到发生时间', help_text=u'提交到服务器上的时间')
...
class Document(models.Model):
    ...
    dateTime = models.DateTimeField(default=getDateTime,auto_created=True, verbose_name=u'创建时间', help_text=u'提交到服务器上的时间')
...
class Examination(models.Model):
    ...
    dateTime = models.DateTimeField(auto_created=True,default=getDateTime, verbose_name=u'创建时间', help_text=u'提交到服务器上的时间')
